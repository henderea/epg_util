...
module EpgUtil
  class Archive
    ...
    register(:command, id: :icon_generator, name: 'generator', aliases: %w(gen icns), short_desc: 'generator [input_file="Icon.png" [output_file="Icon.icns"]]', desc: 'generate a multi-resolution icns file') { |input_file = 'Icon.png', output_file = 'Icon.icns'|
  ...
  register(:command, id: :icon_favicon, name: 'favicon', aliases: %w(fav gen_fav gen_favicon), short_desc: 'favicon [input_file="Icon.png" [output_file="favicon.ico"]]', desc: 'generate a multi-resolution favicon') { |input_file = 'Icon.png', output_file = 'favicon.ico'|
